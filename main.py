...
def main():
    try:
        ...
        driver_manager = DriverManager(driver, svg_manager.obter_svg_list('char'))
        ...
        if tipo_config == "mensagem" and valor:
            ...
            # driver_manager = DriverManager(driver, svg_manager.obter_svg(valor))
            print(f"\nSVG inicial configurado, tipo de botão: {svg_manager.obter_svg_list('char')}")
